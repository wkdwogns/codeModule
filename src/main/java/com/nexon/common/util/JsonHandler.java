...
public class JsonHandler {
    ...
    public static JSONArray getListToJsonArray( List<Map<String, Object>> list )
    {
        ...
        for( Map<String, Object> map : list ) {
            jsonArray.add( getMapToJson( map ) );
        }
    ...
    {
        JSONArray jsonArray = getListToJsonArray( list );
    ...
    public static List<Map<String, Object>> getListMapFromJsonArray( JSONArray jsonArray )
    {
        ...
        if( jsonArray != null )
        {
            ...
            {
                Map<String, Object> map = JsonHandler.getMapFromJsonObject( ( JSONObject ) jsonArray.get(i) );
                list.add( map );
            }
        }
